...
class CollisionCheck {
    ...
    public:
        ...
        CollisionCheck(
            ...
            steps_w= (int) (TRACTOR_WIDTH/RECT_RESOLUTION)+2;
            steps_l_tractor= (int) (l_tractor/RECT_RESOLUTION)+2;
            steps_l_trailer= (int) (l_trailer/RECT_RESOLUTION)+2;
            tractor_coords = Eigen::Matrix3Xd::Zero(3, steps_w*steps_l_tractor);
            trailer_coords = Eigen::Matrix3Xd::Zero(3, steps_w*steps_l_trailer);
        }
